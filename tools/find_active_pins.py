...
products = {
    ...
    "Local Handicrafts": "site:pinterest.com/pin/ \"handicraft\" OR \"statue\"",
    "Herbs & Spices": "site:pinterest.com/pin/ \"spices\" OR \"honey\"",
    "Himalayan Orthodox Golden Tea": "site:pinterest.com/pin/ \"nepal tea\"",
    "Handmade Shakyamuni Buddha Statue": "site:pinterest.com/pin/ \"buddha statue patan\"",
    "Organic Wild Himalayan Honey": "site:pinterest.com/pin/ \"cliff honey nepal\"",
    ...
    "Organic Himalayan Cardamom": "site:pinterest.com/pin/ \"cardamom spices\"",
    "Mt. Everest Arabica Coffee Beans": "site:pinterest.com/pin/ \"nepal coffee beans\""
}
...
def check_url_with_curl(url):
    try:
        ...
        if "200 OK" in res.stdout or "200 OK" in res.stderr:
            return True
...
for name, query in products.items():
        ...
        for pin in unique_pins[:12]:
            ...
            for img_url in img_urls:
                ...
                if check_url_with_curl(url_to_test):
                    ...
                    print(f"-> FOUND 200 OK image: {url_to_test}")
    ...
    if not found_accessible:
        print(f"No 200 OK image found for {name}")
    time.sleep(2)

print("\nAll Verified Hot-linkable Pinterest Images (200 OK):")
print(json.dumps(results, indent=2))
with open("verified_pins.json", "w") as f:
