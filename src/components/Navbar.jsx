          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            {user ? (
              ...
              <Link
                to="/user-login"
                aria-label="Sign in"
                className="bg-slate-950 dark:bg-slate-100 dark:text-slate-950 text-white text-sm font-medium px-4.5 py-2 rounded-full hover:bg-slate-800 dark:hover:bg-slate-200 transition-all duration-250 hover:shadow-lg cursor-pointer focus-ring"
              >
                Sign In
              </Link>
            )}
