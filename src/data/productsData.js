...
},
{
  ...
  description:
    "100% pure raw honey harvested from the wild cliffs of Annapurna region.",
  longDescription:
...
},
{
  ...
  category: "Traditional Apparel",
  description:
    "Ultra-soft, warm, and authentic Chyangra Pashmina shawl hand-woven in Kathmandu Valley.",
  longDescription:
...
},
{
  ...
  images: [
    "https://i.pinimg.com/736x/09/41/ae/0941aefdc7b7a3151698e1c3dcc3853d.jpg"
  ],
  badge: "Artisanal",
  category: "Local Handicrafts",
  description:
    "Genuine hand-forged steel Khukuri, crafted by traditional blacksmiths of Nepal.",
  longDescription:
...
},
{
  ...
  category: "Herbs & Spices",
  description:
    "High-grade, aromatic large cardamom pods harvested in the Eastern hills of Taplejung.",
  longDescription:
...
},
{
  ...
  images: [
    "https://i.pinimg.com/736x/63/0d/01/630d013345d875610fec89f4c28dd2b6.jpg"
  ],
  badge: "Single Origin",
  category: "Organic Tea & Coffee",
  description:
    "Organic single-origin Arabica beans grown in the high altitude volcanic soils of Nuwakot.",
  longDescription:
    "Experience the rich aroma and smooth taste of Nepal's premium single-origin Arabica coffee. Carefully cultivated in the fertile highlands of Nuwakot, these organically grown beans are handpicked, naturally processed, and expertly roasted to preserve their unique flavor. Every cup delivers notes of chocolate, caramel, and subtle fruity undertones, making it an excellent choice for coffee lovers seeking an authentic Himalayan coffee experience.",
  addedBy: "admin",
},
{
  id: 9,
  ...
  category: "Traditional Apparel",
  description:
    "Authentic Nepali Daura Suruwal made from premium cotton.",
  longDescription:
...
},
{
  ...
  category: "Traditional Apparel",
  description:
    "Traditional Nepali women's dress handcrafted with quality fabric.",
  longDescription:
...
},
{
  ...
  category: "Traditional Apparel",
  description:
    "Traditional Newari black and red sari, handwoven in Nepal.",
  longDescription:
...
},
{
  ...
  category: "Traditional Apparel",
  description:
    "Classic black Bhadgaule Topi handcrafted in Bhaktapur, a timeless symbol of Nepali tradition.",
  longDescription:
...
},
{
  ...
  category: "Traditional Apparel",
  description:
    "Beautiful Dhaka saree woven with traditional Nepali patterns, ideal for festivals and special occasions.",
  longDescription:
...
},
{
  ...
  category: "Local Handicrafts",
  description:
    "Intricately carved wooden peacock window, a classic masterpiece of Newari architecture.",
  longDescription:
...
},
{
  ...
  category: "Herbs & Spices",
  description:
    "100% pure Himalayan Shilajit, sustainably sourced from high altitude rocks.",
  longDescription:
...
},
{
  ...
  category: "Local Handicrafts",
  description:
    "Hand-hammered brass singing bowl set for meditation and sound healing.",
  longDescription:
...
=======
    ...
    name: "Premium Dhaka Topi (Handwoven)",
    price: 1200,
    // Dhaka Topi — the classic red/green Nepali cap
    image: "https://i.pinimg.com/736x/d4/16/12/d41612e4db1ef4157d6e3f11e4b832c0.jpg",
  ...
  },
  {
    ...
    name: "Himalayan Orthodox Golden Tea",
    price: 850,
    // Ilam golden tea — loose leaf in a cup
    image: "https://i.pinimg.com/736x/56/d0/7f/56d07fba8ab764c361db3999425b48f1.jpg",
  ...
  },
  {
    ...
    name: "Organic Himalayan Cardamom (Alaichi)",
    price: 650,
    // Cardamom pods — large green cardamom
    image: "https://i.pinimg.com/736x/28/c6/48/28c648b0a74979111f737955b05d05cd.jpg",
...
=======
    const DATA_VERSION = "v7-stock-update-2"
>>>>>>> sahil
