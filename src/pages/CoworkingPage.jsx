...
const CoworkingPage = () => {
  ...
  const coworkingPlans = [
    {
      ...
      description:
        "A comfortable seat in our open area. Perfect for working on your laptop and meeting other creative people.",
      features: [
    ...
    },
    {
      ...
      description:
        "Your own personal desk that belongs only to you. You can safely leave your computer and notes overnight.",
      features: [
    ...
    },
    {
      ...
      description:
        "A private, lockable room for your team. Fits 4 to 6 people comfortably with access to all shared spaces.",
      features: [
      ...
      icon: (
        ...
        >
          <path
            ...
            d="M8.288 15.038a5.25 5.25 0 017.424 0M5.106 11.856a9.75 9.75 0 0113.788 0M1.924 8.674a14.25 14.25 0 0120.152 0M12 18.75h.008v.008H12v-.008z"
          />
        </svg>
      ),
    },
      ...
      icon: (
        ...
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M6.72 13.82l-.24 2.25H5.25m3-.75l-.24 2.25H6.75M9 13.5l-.24 2.25H7.5m3-.75l-.24 2.25H9m3-1.5l-.24 2.25h-1.5m3-.75l-.24 2.25H12m3-1.5l-.24 2.25h-1.5m3-.75l-.24 2.25H15M21 12a9 9 0 11-18 0 9 9 0 0118 0z"
          />
        </svg>
      ),
    },
  ...
  const handleBookingSubmit = (e) => {
    ...
    setTimeout(() => {
      toastSuccess(
        `Tour request successfully booked for ${bookingForm.date}! We will call you shortly.`,
      );
      setBookingForm({
        name: "",
        email: "",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-6 space-y-6 text-left">
            ...
            <p className="text-slate-500 dark:text-slate-400 text-base leading-relaxed max-w-xl">
              We believe in helping local creators grow. We built a friendly
              workspace in Kathmandu where freelancers, craftsmakers, and small
              teams can work, share ideas, and enjoy fresh local coffee under
              one roof.
            </p>
            ...
            <div className="pt-4 flex items-center gap-4">
              <a
                href="#plans"
                className="bg-slate-900 dark:bg-slate-100 hover:bg-slate-800 dark:hover:bg-white text-white dark:text-slate-900 font-bold px-6 py-3.5 rounded-xl transition duration-150 cursor-pointer text-sm"
              >
        ...
        >
          {Array.from({ length: 4 })
            ...
            .map((item, i) => (
              <span
                key={i}
                className="inline-flex items-center gap-2 text-xs font-semibold px-8 text-slate-500 dark:text-slate-400"
              >
                {item}
                <span className="text-slate-300 dark:text-slate-800 ml-4 font-light">
                  /
                </span>
              </span>
            ))}
        ...
        <div className="bg-slate-50 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-850 rounded-2xl p-8 shadow-sm">
          <div className="text-left mb-8">
            ...
            <p className="text-slate-500 dark:text-slate-400 text-xs mt-1">
              Provide your scheduling preference below to arrange a physical
              space view or corporate walkthrough.
            </p>
          </div>
          ...
          <form onSubmit={handleBookingSubmit} className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              <select
                ...
                onChange={(e) =>
                  setBookingForm({ ...bookingForm, plan: e.target.value })
                }
              ...
              >
                ...
                <option value="dedicated-desk">
                  Monthly Dedicated Fixed Desk
                </option>
                <option value="private-suite">
                  Monthly Corporate Private Suite
                </option>
              </select>
            </div>
            ...
            <div className="pt-4">
              ...
              >
                {isSubmitting ? (
                  <>
                    <svg
                      className="animate-spin h-4.5 w-4.5 text-slate-500"
